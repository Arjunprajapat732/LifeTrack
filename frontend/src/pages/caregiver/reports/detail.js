...
import { ArrowLeft, FileText, User, Calendar, Clock, Download, Eye, AlertCircle, Home } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-6">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <Link to="/caregiver/reports" className="hover:text-primary-600 transition-colors">
                Reports
              </Link>
              <span>/</span>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{report.patientId?.firstName} {report.patientId?.lastName}</p>
                </div>
              </div>
