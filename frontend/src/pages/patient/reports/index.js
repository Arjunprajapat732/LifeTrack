...
const PatientReportsIndex = () => {
  ...
  const viewReport = (reportId) => {
    navigate(`/patient/reports/detail/${reportId}`);
  };
                ...
                {sortedReports.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="6" className="px-6 py-12 text-center text-gray-500">
                      ...
                      <p className="text-sm">You haven't uploaded any reports yet</p>
                    </td>
                  </tr>
                )}
              </tbody>
...
export default PatientReportsIndex;
